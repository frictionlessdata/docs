...
---
By Open Knowledge Greece, [originally published](https://okfnlabs.org/blog/2018/02/14/datapackages-in-r.html) on 2018-02-14

*The [Open Knowledge Greece][okgreece] was one of 2017's [Frictionless Data Tool Fund][toolfund] grantees tasked with extending implementation of core Frictionless Data libraries in R programming language. You can read more about this in [their grantee profile][toolfund-okgreece].*
...
You can further manipulate list objects in R by using the [purrr](https://cran.r-project.org/package=purrr), and [rlist](https://cran.r-project.org/package=rlist) packages.
